    ...
    <template v-slot:default>
      ...
      <div class="m-table-container">
        <table class="m-table mx-auto">
          ...
          <tbody>
            <tr class="m-tr tr-list" v-for="(item, index) in enterpriseLog" :key="index">
              <td class="m-td">
                <span class="m-value">
                  {{ item.user_id }}
                </span>
  ...
  export default {
    ...
    methods: {
      getEnterpriseLog() {
        ...
        this.apiGet("si/enterprise_log", data).then(({ data }) => {
          this.enterpriseLog = data;
        });
      },
      cancel() {
        this.$emit("cancel");
